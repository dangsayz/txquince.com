...
export const home = {
  ...
  packages: {
    ...
    body: "Fixed pricing, no surprises — coverage runs 5 to 8 hours by collection, reserved with a deposit and split into interest-free payments. Most families choose Signature.",
