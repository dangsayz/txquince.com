...
export function HomePricing() {
  ...
  return (
    <div>
        ...
        {packages.map((x) => {
          ...
          return (
            <button
              ...
              onClick={() => setSel(x.id)}
              className={`relative rounded-2xl border px-4 py-3.5 text-left transition-all duration-300 ${
                active
      ...
      <div key={sel} className="fade-only mt-8 rounded-[1.5rem] border border-ink/15 bg-white p-7 md:p-9">
