...
export function ShareModal({
  ...
  return createPortal(
    ...
    >
      ...
      {/* sheet */}
      <div className="share-pop relative w-full max-w-sm rounded-t-[1.75rem] border border-line bg-cream p-6 shadow-[0_-20px_60px_-20px_rgba(28,26,23,0.4)] sm:rounded-[1.75rem] sm:shadow-[0_30px_80px_-30px_rgba(28,26,23,0.5)]">
        {/* grab handle (mobile) */}
