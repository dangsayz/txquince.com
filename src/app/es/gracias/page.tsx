...
export default function GraciasPage() {
  return <section className="mx-auto flex min-h-[70svh] max-w-2xl flex-col items-center justify-center px-5 py-20 text-center md:px-10 lg:px-16">
    ...
    <p className="mt-6 max-w-md text-base leading-7 text-ink-soft">Confirmaremos si la fecha está disponible y responderemos tus preguntas personalmente. Si no recibes un correo, puedes escribirnos directamente.</p>
